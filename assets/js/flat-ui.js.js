...
(function ($, undefined) {
    ...
    function measureScrollbar () {
        ...
        $template.appendTo('#iaa_bootstraped.iaa_bootstraped.iaa_panel');
    ...
    function measureTextWidth(e) {
        if (!sizer){
            ...
            $("#iaa_bootstraped.iaa_bootstraped.iaa_panel").append(sizer);
        }
        sizer.text(e.val());
        return sizer.width();
    }
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            this.liveRegion = $("<span>", {
                ...
                .appendTo('#iaa_bootstraped.iaa_bootstraped.iaa_panel');
            ...
            this.body = $("#iaa_bootstraped.iaa_bootstraped.iaa_panel");
